...
Para.LearningItems.IsWeightTraining=false; % whether to train the attribute weights w_i^u and w_j^p. For some categories, choosing "false" may lead to a more stable learning process.
